(()=>{
    ...
    e.popup = new class {
        ...
        eventsPopup() {
            document.addEventListener("click", function(e) {
                ...
                if (t)
                    ...
                    void this.open()) : void this.popupLogging(`Йой, не заповнено атрибут у ${t.classList}`);
        ...
        open(e) {
            if (n)
                if (this.bodyLock = !(!document.documentElement.classList.contains("lock") || this.isOpen),
                ...
                this.targetOpen.element) {
                    if (this.youTubeCode) {
                        ...
                        if (t.setAttribute("allow", `${s}; encrypted-media`),
    ...
    let p = (e,t=!1,s=500,i=0)=>{
        ...
        if (n) {
            ...
            l(`[gotoBlock]: Йой... Такого блоку немає на сторінці: ${e}`)
    }
    ;
    function u(e) {
        ...
        for (let n = 1; n < e.length; n += 1) {
            ...
            !("undefined" != typeof window && void 0 !== window.HTMLElement ? i instanceof HTMLElement : i && (1 === i.nodeType || 11 === i.nodeType)))) {
                ...
                for (let s = 0, i = e.length; s < i; s += 1) {
                    ...
                    void 0 !== n && n.enumerable && (S(t[i]) && S(r[i]) ? r[i].__swiper__ ? t[i] = r[i] : T(t[i], r[i]) : !S(t[i]) && S(r[i]) ? (t[i] = {},
                    r[i].__swiper__ ? t[i] = r[i] : T(t[i], r[i])) : t[i] = r[i])
                }
            }
        }
        var i;
    ...
    function z(e={}) {
        return k || (k = function({userAgent: e}={}) {
            ...
            const c = n.match(/(iPod)(.*OS\s([\d_]+))?/)
              ...
              , u = "Win32" === i;
            let h = "MacIntel" === i;
            return !d && h && t.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${a}x${o}`) >= 0 && (d = n.match(/(Version)\/([\d.]+)/),
            d || (d = [0, 1, "13_0_0"]),
            h = !1),
            l && !u && (r.os = "android",
            r.android = !0),
    ...
    const H = {
        ...
        updateSlides: function() {
            ...
            const i = e.params
              , {wrapperEl: n, slidesEl: r, size: a, rtlTranslate: o, wrongRTL: l} = e
            ...
            i.centeredSlides && i.cssMode && (E(n, "--swiper-centered-offset-before", ""),
            E(n, "--swiper-centered-offset-after", ""));
            ...
            for (let n = 0; n < u; n += 1) {
                ...
                !p[n] || "none" !== P(r, "display")) {
                    if ("auto" === i.slidesPerView) {
                        ...
                        i.roundLengths)
                            M = e.isHorizontal() ? O(r, "width", !0) : O(r, "height", !0);
                        else {
                            const e = s(a, "width")
                              , t = s(a, "padding-left")
                              , i = s(a, "padding-right")
                        ...
                        M = (a - (i.slidesPerView - 1) * b) / i.slidesPerView,
                        i.roundLengths && (M = Math.floor(M)),
                        p[n] && (p[n].style[t("width")] = `${M}px`);
                    p[n] && (p[n].swiperSlideSize = M),
                    f.push(M),
                    i.centeredSlides ? (S = S + M / 2 + T / 2 + b,
                    0 === T && 0 !== n && (S = S - a / 2 - b),
                    0 === n && (S = S - a / 2 - b),
                    Math.abs(S) < .001 && (S = 0),
                    i.roundLengths && (S = Math.floor(S)),
                    x % i.slidesPerGroup == 0 && h.push(S),
                    m.push(S)) : (i.roundLengths && (S = Math.floor(S)),
                    (x - Math.min(e.params.slidesPerGroupSkip, x)) % e.params.slidesPerGroup == 0 && h.push(S),
                    m.push(S),
                    S = S + M + b),
                    e.virtualSize += M + b,
                    T = M,
            ...
            o && l && ("slide" === i.effect || "coverflow" === i.effect) && (n.style.width = `${e.virtualSize + i.spaceBetween}px`),
            i.setWrapperSize && (n.style[t("width")] = `${e.virtualSize + i.spaceBetween}px`),
            ...
            i.centeredSlides && i.cssMode && !i.centeredSlidesBounds) {
                E(n, "--swiper-centered-offset-before", -h[0] + "px"),
                E(n, "--swiper-centered-offset-after", e.size / 2 - f[f.length - 1] / 2 + "px");
        ...
        updateActiveIndex: function(e) {
            ...
            let p;
            p = t.virtual && n.virtual.enabled && n.loop ? c(d) : t.slides[d] ? parseInt(t.slides[d].getAttribute("data-swiper-slide-index") || d, 10) : d,
            Object.assign(t, {
                snapIndex: l,
                realIndex: p,
                previousIndex: r,
        ...
        updateClickedSlide: function(e) {
            ...
            t.clickedSlide = i,
            t.virtual && t.params.virtual.enabled ? t.clickedIndex = parseInt(i.getAttribute("data-swiper-slide-index"), 10) : t.clickedIndex = n,
    ...
    const F = {
        slideTo: function(e=0, t=this.params.speed, s=!0, i, n) {
            ...
            let a = e;
            a < 0 && (a = 0);
            const {params: o, snapGrid: l, slidesGrid: d, previousIndex: c, activeIndex: p, rtlTranslate: u, wrapperEl: h, enabled: m} = r;
        ...
        slideToLoop: function(e=0, t=this.params.speed, s=!0, i) {
            ...
            const n = this;
            let r = e;
            return n.params.loop && (n.virtual && n.params.virtual.enabled ? r += n.virtual.slidesBefore : r = n.getSlideIndexByData(r)),
            n.slideTo(r, t, s, i)
        },
        ...
        slideToClickedSlide: function() {
            ...
            if (t.loop) {
                ...
                r = e.getSlideIndex(L(s, `${a}[data-swiper-slide-index="${n}"]`)[0]),
                w((()=>{
                    e.slideTo(r)
                }
    ...
    const N = {
        ...
        loopFix: function({slideRealIndex: e, slideTo: t=!0, direction: s, setTranslate: i, activeSlideIndex: n, byController: r, byMousewheel: a}={}) {
            const o = this;
            if (!o.params.loop)
                return;
            ...
            o.virtual && u.virtual.enabled)
                return t && (u.centeredSlides || 0 !== o.snapIndex ? u.centeredSlides && o.snapIndex < u.slidesPerView ? o.slideTo(o.virtual.slides.length + o.snapIndex, 0, !1, !0) : o.snapIndex === o.snapGrid.length - 1 && o.slideTo(o.virtual.slidesBefore, 0, !1, !0) : o.slideTo(o.virtual.slides.length, 0, !1, !0)),
                o.allowSlidePrev = d,
                o.allowSlideNext = c,
                void o.emit("loopFix");
            ...
            let b = 0
              , S = 0;
            if (n < m) {
                b = Math.max(m - n, u.slidesPerGroup);
            ...
            t)
                if (f.length > 0 && y)
                    if (void 0 === e) {
                        ...
                        a ? o.setTranslate(o.translate - t) : (o.slideTo(v + b, 0, !1, !0),
                    ...
                    if (void 0 === e) {
                        ...
                        a ? o.setTranslate(o.translate - t) : (o.slideTo(v - S, 0, !1, !0),
                        i && (o.touches[o.isHorizontal() ? "startX" : "startY"] += t))
                    } else
    ...
    function j(e) {
        ...
        let S = !0;
        d.matches(n.focusableElements) && (S = !1,
        "SELECT" === d.nodeName && (n.isTouched = !1)),
        s.activeElement && s.activeElement.matches(n.focusableElements) && s.activeElement !== d && s.activeElement.blur();
        const T = S && t.allowTouchMove && r.touchStartPreventDefault;
        !r.touchStartForcePreventDefault && !T || d.isContentEditable || l.preventDefault(),
    ...
    function R(e) {
        ...
        if (l.preventedByNestedSwiper)
            ...
            void (r.startY = u);
        if (!s.allowTouchMove)
            return l.target.matches(i.focusableElements) || (s.allowClick = !1),
        ...
        n.oneWayMovement && (g = Math.abs(g) * (a ? 1 : -1),
        v = Math.abs(v) * (a ? 1 : -1)),
        r.diff = g,
        g *= n.touchRatio,
        a && (g = -g,
        ...
        let S;
        i.isMoved && w !== s.touchesDirection && b && Math.abs(g) >= 1 && (s.loopFix({
            direction: s.swipeDirection,
            setTranslate: !0
        }),
        S = !0),
        ...
        let T = !0
          , E = n.resistanceRatio;
        if (n.touchReleaseOnEdges && (E = 0),
        g > 0 ? (b && !S && i.currentTranslate > (n.centeredSlides ? s.minTranslate() - s.size / 2 : s.minTranslate()) && s.loopFix({
            direction: "prev",
            setTranslate: !0,
            activeSlideIndex: 0
        }),
        i.currentTranslate > s.minTranslate() && (T = !1,
        n.resistance && (i.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + i.startTranslate + g) ** E))) : g < 0 && (b && !S && i.currentTranslate < (n.centeredSlides ? s.maxTranslate() + s.size / 2 : s.maxTranslate()) && s.loopFix({
            direction: "next",
            setTranslate: !0,
        ...
        n.resistance && (i.currentTranslate = s.maxTranslate() + 1 - (s.maxTranslate() - i.startTranslate - g) ** E))),
    ...
    function Y(e) {
        ...
        const {params: n, touches: r, rtlTranslate: a, slidesGrid: o, enabled: l} = t;
        if (!l)
            return;
        if (!n.simulateTouch && "mouse" === e.pointerType)
            return;
        ...
        s.isMoved = !1,
        s.startMoving = !1,
        u = n.followFinger ? a ? t.translate : -t.translate : -s.currentTranslate,
        n.cssMode)
            return;
        ...
        if (p > n.longSwipesMs) {
            ...
            "next" === t.swipeDirection && (v >= n.longSwipesRatio ? t.slideTo(n.rewind && t.isEnd ? f : h + b) : t.slideTo(h)),
            "prev" === t.swipeDirection && (v > 1 - n.longSwipesRatio ? t.slideTo(h + b) : null !== g && v < 0 && Math.abs(v) > n.longSwipesRatio ? t.slideTo(g) : t.slideTo(h))
        } else {
            if (!n.shortSwipes)
                return void t.slideTo(t.activeIndex);
            t.navigation && (d.target === t.navigation.nextEl || d.target === t.navigation.prevEl) ? d.target === t.navigation.nextEl ? t.slideTo(h + b) : t.slideTo(h) : ("next" === t.swipeDirection && t.slideTo(null !== f ? f : h + b),
    ...
    function U() {
        ...
        e.autoplay && e.autoplay.running && e.autoplay.paused && (clearTimeout(X),
        X = setTimeout((()=>{
    ...
    const re = {
        ...
        events: {
            attachEvents: function() {
                ...
                e.onClick = K.bind(e),
                e.onLoad = Z.bind(e),
                J || (t.addEventListener("touchstart", ee),
                J = !0),
                te(e, "on")
            },
        ...
        breakpoints: {
            setBreakpoint: function() {
                ...
                const o = (a in r ? r[a] : void 0) || e.originalParams
                  ...
                  , d = se(e, o)
                  , c = i.enabled;
                l && !d ? (n.classList.remove(`${i.containerModifierClass}grid`, `${i.containerModifierClass}grid-column`),
                e.emitContainerClasses()) : !l && d && (n.classList.add(`${i.containerModifierClass}grid`),
    ...
    class oe {
        ...
        mount(e) {
            ...
            return !n && t.params.createElements && (n = C("div", t.params.wrapperClass),
            s.append(n),
        ...
        static use(e) {
            return Array.isArray(e) ? (e.forEach((e=>oe.installModule(e))),
            oe) : (oe.installModule(e),
            oe)
        }
    }
    ...
    oe.use([function({swiper: e, on: t, emit: s}) {
        const i = v();
        let n = null
          , r = null;
        const a = ()=>{
    ...
    function ce({swiper: e, extendParams: t, on: s, emit: i, params: n}) {
        let r, a;
        e.autoplay = {
            running: !1,
            paused: !1,
        ...
        let o, l, d, c, p, u, h, m = n && n.autoplay ? n.autoplay.delay : 3e3, g = n && n.autoplay ? n.autoplay.delay : 3e3, v = (new Date).getTime;
        function w(t) {
        ...
        const y = ()=>{
          ...
          , b = t=>{
            ...
            !Number.isNaN(n) && n > 0 && void 0 === t && (s = n,
            m = n,
            g = n),
            o = s;
            const l = e.params.speed
              , d = ()=>{
                e && !e.destroyed && (e.params.autoplay.reverseDirection ? !e.isBeginning || e.params.loop || e.params.rewind ? (e.slidePrev(l, !0, !0),
                i("autoplay")) : e.params.autoplay.stopOnLastSlide || (e.slideTo(e.slides.length - 1, l, !0, !0),
                i("autoplay")) : !e.isEnd || e.params.loop || e.params.rewind ? (e.slideNext(l, !0, !0),
                i("autoplay")) : e.params.autoplay.stopOnLastSlide || (e.slideTo(0, l, !0, !0),
                i("autoplay")),
          ...
          , E = (t,s)=>{
            ...
            const n = ()=>{
                i("autoplayPause"),
                e.params.autoplay.waitForTransition ? e.wrapperEl.addEventListener("transitionend", w) : x()
            }
            ;
            if (e.autoplay.paused = !0,
            s)
                return u && (o = e.params.autoplay.delay),
                u = !1,
                void n();
        ...
        s("sliderFirstMove", (()=>{
            !e.destroyed && e.autoplay.running && (e.params.autoplay.disableOnInteraction ? T() : (d = !0,
            c = !1,
            h = !1,
            p = setTimeout((()=>{
                h = !0,
    ...
    window.addEventListener("load", (function(e) {
        document.querySelector(".slider-page__slider") && new le(".slider-page__slider",{
            modules: [de, ce],
            observer: !0,
            observeParents: !0,
            slidesPerView: 4,
    ...
    ("max").init();
    const ue = document.querySelector(".sale-header__close")
      , he = document.querySelector(".sale-header__button")
      , me = document.querySelector(".header__sale")
      , fe = document.querySelector(".sale-header__none")
      , ge = document.querySelector(".hero-page__container");
    ue.addEventListener("click", (function() {
        me.classList.add("_close-banner"),
        ge && (ge.style.cssText = "padding-top: 100px;",
        ge.style.cssText = "min-height: 52.5vh;")
    }
    )),
        ...
        if (e.length > 0) {
            ...
            function r(e, t=!1) {
                e.forEach((e=>{
                    ...
                    a(e),
                    e.addEventListener("click", o)) : (e.classList.remove("_spoller-init"),
                    a(e, !1),
            ...
            function a(e, t=!0) {
                ...
                s.forEach((e=>{
                    ...
                    e.classList.contains("_spoller-active") || (e.nextElementSibling.hidden = !0)) : (e.setAttribute("tabindex", "-1"),
            ...
            function o(e) {
                ...
                if (t.closest("[data-spoller]")) {
                    const n = t.closest("[data-spoller]")
                      ...
                      , o = r.dataset.spollersSpeed ? parseInt(r.dataset.spollersSpeed) : 500;
                    r.querySelectorAll("._slide").length || (a && !n.classList.contains("_spoller-active") && l(r),
            ...
            function l(e) {
                ...
                t && !e.querySelectorAll("._slide").length && (t.classList.remove("_spoller-active"),
            ...
            d.length && document.addEventListener("click", (function(e) {
                e.target.closest("[data-spollers]") || d.forEach((e=>{
                    ...
                    if (t.classList.contains("_spoller-init")) {
                        const i = t.dataset.spollersSpeed ? parseInt(t.dataset.spollersSpeed) : 500;
        ...
        function s(t) {
            if ("click" === t.type) {
                ...
                if (s.closest("[data-goto]")) {
                    ...
                    if (e.fullpage) {
                        const t = document.querySelector(`${n}`).closest("[data-fp-section]")
                          , s = t ? +t.dataset.fpId : null;
                        null !== s && (e.fullpage.switchingSection(s),
    ...
    function() {
        ...
        document.addEventListener("windowScroll", (function(a) {
            ...
            clearTimeout(n),
            o >= i ? (!e.classList.contains("_header-scroll") && e.classList.add("_header-scroll"),
            t && (o > r ? e.classList.contains("_header-show") && e.classList.remove("_header-show") : !e.classList.contains("_header-show") && e.classList.add("_header-show"),
            n = setTimeout((()=>{
